...
public class EngineeringLevel3ChestplateModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // 🔥 THE INFLATION RULES 🔥
        CubeDeformation armorInflation = new CubeDeformation(0.25F); // Inflates base armor to hide player skin
        CubeDeformation noInflation = new CubeDeformation(0.0F);     // Keeps 3D details crisp and sharp

        // ==========================================
        // BASE TORSO & BELT (Baked to Native Y=24)
        // ==========================================
        ...
        // ==========================================
        // FRONT DETAILS (Ribs moved UP by 0.2 / Y=0.0F)
        // ==========================================
        ...
        // TABLET (Kept exactly where it was at Y=0.2F)
        ...
        // ==========================================
        // BACK DETAILS (Ribs moved UP by 0.2 / Y=0.0F)
        // ==========================================
        ...
        // SPINE (Kept exactly where it was at Y=0.2F)
        ...
        // ==========================================
        // RIGHT ARM (Baked to Native Coordinates)
        // ==========================================
        PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create()
        .texOffs(16, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, armorInflation) // Main Sleeve
        .texOffs(10, 32).addBox(0.0F, -2.2F, -2.0F, 1.0F, 1.0F, 4.0F, armorInflation), // Shoulder Pad
        PartPose.ZERO); 
        ...
        PartPose.offset(-0.25F, 0.0F, 0.0F)); // Panels pushed OUT by -0.25 X
        ...
        // ==========================================
        // LEFT ARM (Baked to Native Coordinates)
        // ==========================================
        PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create()
        .texOffs(0, 16).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, armorInflation) // Main Sleeve
        .texOffs(0, 32).addBox(-1.0F, -2.2F, -2.0F, 1.0F, 1.0F, 4.0F, armorInflation), // Shoulder Pad
        PartPose.ZERO); 
